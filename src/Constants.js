class Constants {
    ...
    static ADDITIONAL_QUESTIONS = [
        ...
        { id: 'Q21r1', question: 'Quels sont les obstacles les plus importants que v…lancer votre entreprise? - Obtenir du financement', reponseText: ["non", "oui"], reponseValue: [0, 1] },
